...
public class RestS3Service extends S3Service
{
        ...
        throws S3ServiceException
    {
        ...
        this.setRequesterPaysEnabled(this.jets3tProperties.getBoolProperty("httpclient.requester-pays-buckets-enabled",
            false));
    }
    ...
    {
        return Constants.GS_DEFAULT_HOSTNAME.equals(this.getJetS3tProperties()
            .getStringProperty("s3service.s3-endpoint", null));
    }
    ...
    {
        return this.jets3tProperties.getStringProperty("hw-endpoint", Constants.HW_DEFAULT_HOSTNAME);
    }
    ...
    {
        return this.jets3tProperties.getStringProperty("hw-endpoint-virtual-path", "");
    }
    ...
    protected BaseVersionOrDeleteMarker[] listVersionedObjectsImpl(String bucketName, String prefix, String delimiter,
        ...
        throws S3ServiceException
    {
        return listVersionedObjectsInternal(bucketName,
            prefix,
            delimiter,
            maxListingLength,
            true,
            keyMarker,
            versionMarker).getItems();
    }
        ...
        throws S3ServiceException
    {
        return listVersionedObjectsInternal(bucketName,
            ...
            delimiter,
            maxListingLength,
            automaticallyMergeChunks,
            keyMarker,
            versionMarker).getItems();
    }
    
    @Override
    protected void updateBucketVersioningStatusImpl(String bucketName, String status,
        boolean multiFactorAuthDeleteEnabled, String multiFactorSerialNumber, String multiFactorAuthCode)
        throws S3ServiceException
    {
        if (log.isDebugEnabled())
        {
            log.debug(status + " versioning for bucket " + bucketName
                + (multiFactorAuthDeleteEnabled ? " with Multi-Factor Auth enabled" : ""));
        }
        try
        {
            XMLBuilder builder =
                XMLBuilder.create("VersioningConfiguration")
                    .a("xmlns", Constants.XML_NAMESPACE)
                    .e("Status")
                    .t(status)
                    .up()
                    .e("MfaDelete")
                    .t((multiFactorAuthDeleteEnabled ? "Enabled" : "Disabled"));
    ...
    @Override
    protected void updateBucketVersioningStatusImpl(String bucketName, boolean enabled,
        boolean multiFactorAuthDeleteEnabled, String multiFactorSerialNumber, String multiFactorAuthCode)
        throws S3ServiceException
    {
        if (log.isDebugEnabled())
        {
            log.debug((enabled ? "Enabling" : "Suspending") + " versioning for bucket " + bucketName
                + (multiFactorAuthDeleteEnabled ? " with Multi-Factor Auth enabled" : ""));
        }
        try
        {
        ...
        throws S3ServiceException
    {
        try
        {
            ...
            return getXmlResponseSaxParser().parseVersioningConfigurationResponse(new HttpMethodReleaseInputStream(
                response));
        }
        catch (ServiceException se)
        {
    ...
    protected VersionOrDeleteMarkersChunk listVersionedObjectsInternal(String bucketName, String prefix,
        String delimiter, long maxListingLength, boolean automaticallyMergeChunks, String nextKeyMarker,
        ...
        throws S3ServiceException
    {
        ...
        while (incompleteListing)
        {
            ...
            {
                handler =
                    getXmlResponseSaxParser().parseListVersionsResponse(new HttpMethodReleaseInputStream(httpResponse));
                ioErrorRetryCount = 0;
            }
            catch (ServiceException se)
            {
            ...
            if (incompleteListing)
            {
                if (log.isDebugEnabled())
                {
                    log.debug("Yet to receive complete listing of bucket versions, " + "continuing with key-marker="
                        + nextKeyMarker + " and version-id-marker=" + nextVersionIdMarker);
                }
            }
        ...
        if (automaticallyMergeChunks)
        {
            ...
            return new VersionOrDeleteMarkersChunk(bucketName, prefix, delimiter,
                items.toArray(new BaseVersionOrDeleteMarker[items.size()]),
                commonPrefixes.toArray(new String[commonPrefixes.size()]), null, null, incompleteListing);
        }
        else
        {
            return new VersionOrDeleteMarkersChunk(bucketName, prefix, delimiter,
                items.toArray(new BaseVersionOrDeleteMarker[items.size()]),
                commonPrefixes.toArray(new String[commonPrefixes.size()]), nextKeyMarker, nextVersionIdMarker,
                incompleteListing);
        }
    }
    
    @Override
    protected VersionOrDeleteMarkersChunk listVersionedObjectsChunkedImpl(String bucketName, String prefix,
        String delimiter, long maxListingLength, String priorLastKey, String priorLastVersion, boolean completeListing)
        throws S3ServiceException
    {
        return listVersionedObjectsInternal(bucketName,
            prefix,
        ...
        throws S3ServiceException
    {
        ...
        try
        {
            performRestPut(bucketName, null, metadata, requestParameters, new StringEntity(policyDocument,
    ...
    @Override
    protected void forceDeleteBucketImpl(String bucketName)
        throws S3ServiceException
    {
        if (log.isDebugEnabled())
        {
        ...
        throws S3ServiceException
    {
        ...
        {
            HttpResponse httpResponse = performRestGet(bucketName, null, requestParameters, null);
            return getXmlResponseSaxParser().parseRequestPaymentConfigurationResponse(new HttpMethodReleaseInputStream(
                httpResponse));
        }
        catch (ServiceException se)
        {
        ...
        throws S3ServiceException
    {
        ...
        {
            String xml =
                "<RequestPaymentConfiguration xmlns=\"" + Constants.XML_NAMESPACE + "\">" + "<Payer>"
                    + (requesterPays ? "Requester" : "BucketOwner") + "</Payer>" + "</RequestPaymentConfiguration>";
            
            performRestPut(bucketName, null, metadata, requestParameters, new StringEntity(xml, "text/plain",
        ...
        throws S3ServiceException
    {
        ...
        try
        {
            HttpResponse httpResponse =
                performRestPost(bucketName, objectKey, metadata, requestParameters, null, false);
            S3MultipartUpload multipartUpload =
                getXmlResponseSaxParser().parseInitiateMultipartUploadResult(new HttpMethodReleaseInputStream(
                    httpResponse));
        ...
        try
        {
            ...
            if (object.getDataInputStream() != null)
            {
                if (object.containsMetadata(StorageObject.METADATA_HEADER_CONTENT_LENGTH))
                {
                    ...
                    requestEntity =
                        new RepeatableRequestEntity(object.getKey(), object.getDataInputStream(),
            ...
            MultipartPart part =
                new MultipartPart(partNumber, object.getLastModifiedDate(), object.getETag(), object.getContentLength());
            return part;
        }
        catch (ServiceException se)
        {
    ...
    @Override
    protected MultipartPart multipartUploadPartCopyImpl(String uploadId, String targetBucketName,
        String targetObjectKey, Integer partNumber, String sourceBucketName, String sourceObjectKey,
        ...
        throws S3ServiceException
    {
        try
        {
            if (log.isDebugEnabled())
            {
                log.debug("Multipart Copy Object from " + sourceBucketName + ":" + sourceObjectKey + " to upload id="
                    + uploadId + "as part" + partNumber);
            }
            ...
            HttpResponseAndByteCount responseAndByteCount =
                this.performRestPut(targetBucketName, targetObjectKey, metadata, requestParameters, null, false);
            
            MultipartPart part =
                getXmlResponseSaxParser().parseMultipartUploadPartCopyResult(new HttpMethodReleaseInputStream(
                    responseAndByteCount.getHttpResponse()));
    ...
    @Override
    protected void multipartAbortUploadImpl(String uploadId, String bucketName, String objectKey)
        throws S3ServiceException
    {
        Map<String, String> requestParameters = new HashMap<String, String>();
        requestParameters.put("uploadId", uploadId);
    ...
    @Override
    protected MultipartCompleted multipartCompleteUploadImpl(String uploadId, String bucketName, String objectKey,
        ...
        throws S3ServiceException
    {
        ...
        try
        {
            ...
            HttpResponse httpResponse =
                performRestPostWithXmlBuilder(bucketName, objectKey, null, requestParameters, builder);
            CompleteMultipartUploadResultHandler handler =
                getXmlResponseSaxParser().parseCompleteMultipartUploadResult(new HttpMethodReleaseInputStream(
                    httpResponse));
    ...
    @Override
    protected MultipartUploadChunk multipartListUploadsChunkedImpl(String bucketName, String prefix, String delimiter,
        String keyMarker, String uploadIdMarker, Integer maxUploads, boolean autoMergeChunks)
        throws S3ServiceException
    {
        ...
        boolean incompleteListing = true;
        int ioErrorRetryCount = 0;
        int ioErrorRetryMaxCount = jets3tProperties.getIntProperty("httpclient.retry-max", 5);
        ...
        try
        {
            while (incompleteListing)
            {
                ...
                {
                    handler =
                        getXmlResponseSaxParser().parseListMultipartUploadsResult(new HttpMethodReleaseInputStream(
                            httpResponse));
                    ioErrorRetryCount = 0;
                }
            ...
            return new MultipartUploadChunk(prefix, delimiter, uploads.toArray(new S3MultipartUpload[uploads.size()]),
                commonPrefixes.toArray(new String[commonPrefixes.size()]), nextKeyMarker, nextUploadIdMarker,
                maxUploads, incompleteListing);
        }
        catch (ServiceException se)
        {
            throw new S3ServiceException(se);
     ...
     * @throws S3ServiceException
     */
    public S3ListPartsResult listParts(S3ListPartsRequest request)
        throws S3ServiceException
    {
        Map<String, String> requestParameters = new HashMap<String, String>();
        ...
        try
        {
            ...
            ListMultipartPartsResultHandler handler =
                getXmlResponseSaxParser().parseListMultipartPartsResult(new HttpMethodReleaseInputStream(httpResponse));
    ...
    @Override
    protected List<MultipartPart> multipartListPartsImpl(String uploadId, String bucketName, String objectKey)
        throws S3ServiceException
    {
        Map<String, String> requestParameters = new HashMap<String, String>();
        requestParameters.put("uploadId", uploadId);
        ...
        try
        {
            ...
            do
            {
                ...
                ListMultipartPartsResultHandler handler =
                    getXmlResponseSaxParser().parseListMultipartPartsResult(new HttpMethodReleaseInputStream(
                        httpResponse));
                parts.addAll(handler.getMultipartPartList());
    ...
    @Override
    protected S3WebsiteConfiguration getWebsiteConfigImpl(String bucketName)
        throws S3ServiceException
    {
        try
        {
            ...
            return getXmlResponseSaxParser().parseWebsiteConfigurationResponse(new HttpMethodReleaseInputStream(
                getMethod));
        }
        catch (ServiceException se)
        {
        ...
        throws S3ServiceException
    {
        try
        {
            ...
            HttpResponse getMethod = performRestGet(bucketName, null, requestParameters, null);
            return getXmlResponseSaxParser().parseNotificationConfigurationResponse(new HttpMethodReleaseInputStream(
                getMethod));
        }
        catch (ServiceException se)
        {
        ...
        throws S3ServiceException
    {
        try
        {
            ...
            {
                return getXmlResponseSaxParser().parseLifecycleConfigurationResponse(new HttpMethodReleaseInputStream(
                    getMethod));
            }
        }
        catch (ServiceException se)
    ...
    @Override
    public MultipleDeleteResult deleteMultipleObjectsWithMFAImpl(String bucketName,
        ObjectKeyAndVersion[] objectNameAndVersions, String multiFactorSerialNumber, String multiFactorAuthCode,
        boolean isQuiet)
        throws S3ServiceException
    {
        ...
        {
            XMLBuilder builder =
                XMLBuilder.create("Delete")
                    .attr("xmlns", Constants.XML_NAMESPACE)
                    .elem("Quiet")
                    .text((isQuiet ? "true" : "false"))
                    .up();
        ...
        try
        {
            @SuppressWarnings("deprecation")
            HttpResponse httpResponse =
                performRestPost(bucketName, null, metadata, requestParameters, new StringEntity(xml, "text/plain",
